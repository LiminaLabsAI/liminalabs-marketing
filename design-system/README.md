...
<link rel="stylesheet" href="design-system/css/limina.css?v=5.3">

<!-- before </body> -->
<script src="design-system/js/limina.js?v=5.3" defer></script>
```
...
Put a version on the two local URLs (`limina.css?v=5.3`, `limina.js?v=5.3`) and
