...
<link rel="stylesheet" href="design-system/css/limina.css?v=5.7">

<!-- before </body> -->
<script src="design-system/js/limina.js?v=5.7" defer></script>
```
...
Put a version on the two local URLs (`limina.css?v=5.7`, `limina.js?v=5.7`) and
