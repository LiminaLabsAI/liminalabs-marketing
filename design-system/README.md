...
<link rel="stylesheet" href="design-system/css/limina.css?v=4.9">

<!-- before </body> -->
<script src="design-system/js/limina.js?v=4.9" defer></script>
```
...
Put a version on the two local URLs (`limina.css?v=4.9`, `limina.js?v=4.9`) and
