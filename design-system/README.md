...
<link rel="stylesheet" href="design-system/css/limina.css?v=6.0">

<!-- before </body> -->
<script src="design-system/js/limina.js?v=6.0" defer></script>
```
...
Put a version on the two local URLs (`limina.css?v=6.0`, `limina.js?v=6.0`) and
