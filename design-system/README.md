...
<link rel="stylesheet" href="design-system/css/limina.css?v=3.2">

<!-- before </body> -->
<script src="design-system/js/limina.js?v=3.2" defer></script>
```
...
Put a version on the two local URLs (`limina.css?v=3.2`, `limina.js?v=3.2`) and
