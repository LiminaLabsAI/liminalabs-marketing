...
<link rel="stylesheet" href="design-system/css/limina.css?v=4.8">

<!-- before </body> -->
<script src="design-system/js/limina.js?v=4.8" defer></script>
```
...
Put a version on the two local URLs (`limina.css?v=4.8`, `limina.js?v=4.8`) and
