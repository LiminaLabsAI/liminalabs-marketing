...
<link rel="stylesheet" href="design-system/css/limina.css?v=3.4">

<!-- before </body> -->
<script src="design-system/js/limina.js?v=3.4" defer></script>
```
...
Put a version on the two local URLs (`limina.css?v=3.4`, `limina.js?v=3.4`) and
